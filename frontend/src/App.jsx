  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center mt-[3%] w-[80%] mr-[5%] ml-[5%]">
        <h1 className="text-2xl font-medium text-[#555]">
          Expense Tracker App
        </h1>

        <div className="relative flex items-center justify-between mt-5 w-[100%]">
          <div classNmae="relative flex justify-between w-[300px]">
            <button
          ...
          {showAddExpense && (
            <div className="absolute z-[999] flex flex-col p-[10px] top-[20px] left-0 h-[500px] w-[500px] bg-white shadow-xl">
              ...
              <input
                type="text"
                placeholder="Snacks"
                className="0utline-none border-2 border-[#555] border-solid p-[10px]"
              />
              <label htmlFor="" className="mt-[10px] font-semibold text-[18px]">
                Expense Date
              </label>
        ...
        <div className="flex flex-col">
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            ...
            <span className="m-[20px] text-[18px] ">20/4/2025</span>
            <span className="m-[20px] text-[18px] font-medium">Ksh 2000</span>
          ...
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            ...
            <span className="m-[20px] text-[18px] ">1/4/2025</span>
            <span className="m-[20px] text-[18px] font-medium">Ksh 1000</span>
          ...
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            ...
            <span className="m-[20px] text-[18px] ">17/4/2025</span>
            <span className="m-[20px] text-[18px] font-medium">Ksh 2000</span>
          ...
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            ...
            <span className="m-[20px] text-[18px] ">18/3/2025</span>
            <span className="m-[20px] text-[18px] font-medium">Ksh 10000</span>
          ...
          <div className="relative flex justify-between items-center w-[80vw] h-[100px] bg-[#f3edeb] my-[20px] py-[10px]">
            ...
            <span className="m-[20px] text-[18px] ">10/2/2025</span>
            <span className="m-[20px] text-[18px] font-medium">Ksh 3000</span>
        ...
        {showEdit && (
          <div className="absolute z-[999] flex flex-col p-[10px] top-[25%] right-0 h-[400px] w-[300px] bg-white shadow-xl">
            <FaWindowClose
              className="flex justify-end items-end text-2xl text-red-500 cursor-pointer"
